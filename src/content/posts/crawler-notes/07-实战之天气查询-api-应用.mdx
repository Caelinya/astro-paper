...
> **问：**  
> 
> ![Google Chrome ScreenShot](/assets/images/6.webp)
> 
> 我现在要练习天气预报查询。
> 
...
<CodeViewer
  title="天气查询应用代码"
  paths={[
    "src/content/posts/crawler-notes/weather/weather.py",
    "src/content/posts/crawler-notes/weather/weather_code.json",
    "src/content/posts/crawler-notes/weather/example_weather.json"
  ]}
/>
